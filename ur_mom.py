...
def inventory_menu(inventory):
    cool_print(f"Your inventory via actions: {inventory}")


def left(inventory, hp, energy, max_hp, max_energy):
    ...
    if chest_choice == "sleep":
        sleep(hp, energy, max_hp, max_energy)
        return True
    ...
    if bed_choice == "sleep":
        sleep(hp, energy, max_hp, max_energy)
        return inventory, hp, energy, max_hp, max_energy


def right(inventory, hp, energy, max_hp, max_energy):
    ...
    inventory, hp, energy, max_hp, max_energy = first_fight_right(inventory, hp, energy, max_hp, max_energy)
    
    # Second fight in right path
    inventory, hp, energy, max_hp, max_energy = second_fight_right(inventory, hp, energy, max_hp, max_energy)

    return inventory, hp, energy, max_hp, max_energy


def first_fight_right(inventory, hp, energy, max_hp, max_energy):
...
def second_fight_right(inventory, hp, energy, max_hp, max_energy):
    ...
    if bed_choice == "sleep":
        ...
        if choice == "left":
            left(inventory, hp, energy, max_hp, max_energy)
        elif dodge == "right":
...
def get_input_with_inventory(prompt, inventory, hp, energy, max_hp, max_energy):
    while True:
        ...
        if user_input == "inventory":
            cool_print(f"Your inventory via input_inventory: {inventory}")
...
def adventure_path():
    ...
    energy = [max_energy]
    while True:
        cool_print("\nYou're in a dark room, you see two paths, one to the left and one to the right.")
        ...
        #TODO: what happens if choice comes back as None?
    
        if choice == "sleep":
            hp, energy, max_hp, max_energy = sleep(hp, energy, max_hp, max_energy)
        
        if choice == "left":
            inventory, hp, energy, max_hp, max_energy =left(inventory, hp, energy, max_hp, max_energy)

        elif choice == "right":
            inventory, hp, energy, max_hp, max_energy = right(inventory, hp, energy, max_hp, max_energy)
